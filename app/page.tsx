...
import { ChevronLeft, ChevronRight, Sparkles, ArrowRight, ShieldCheck, Database, Zap } from 'lucide-react';
import Link from 'next/link';

export default function HomePage() {
  const [currentSlide, setCurrentSlide] = useState(0);
  
  // Sample slides (will be fetched from Supabase in production)
  const slides = [
    {
      id: 1,
      title: "Premium Cotton & Agricultural Commodities",
      text: "Managing Hasnain Corporation & H.A. Cotton Ginners with advanced digital infrastructure.",
      image: "https://images.unsplash.com/photo-1599818814474-cb72b38062a7?auto=format&fit=crop&w=1200&q=80"
    },
    {
      id: 2,
      title: "Secure Supabase Database & Storage",
      text: "Lightning-fast image, video, and PDF document storage with real-time sync.",
      image: "https://images.unsplash.com/photo-1586771107445-d3ca888129ff?auto=format&fit=crop&w=1200&q=80"
    },
    {
      id: 3,
      title: "Resend OTP Verification & Role Security",
      text: "Instant email verification and comprehensive admin user control dashboard.",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Hero Slideshow Section (Airbnb Style) */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        ...
        <div className="card-3d p-8 border border-gray-100 flex flex-col items-start">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Resend OTP & Admin Control</h3>
          <p className="text-gray-600 text-sm leading-relaxed mb-4">
            Secure user authentication via Resend email OTP and full admin control panel for user statuses.
          </p>
