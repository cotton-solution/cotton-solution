...
const cards = [
  {
    ...
    icon: ReceiptText,
    description: "Record and track bills received from vendors",
  },
  {
    label: "Suppliers / Vendors",
    href: "/purchases/suppliers",
    icon: Truck,
    description: "Vendor contacts and ledger management",
  },
  {
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Everything to do with vendors, bills and what you owe.
        </p>
      </div>
