...
export default function DocumentsPage() {
  const [documents] = useState([
    {
      id: 1,
      name: "Cotton Ginning Agreement V1.pdf",
      detail: "Standard operating agreement and lease terms for ginning units.",
      url: "#"
    },
    {
      id: 2,
      name: "Tax & Asset Declaration Form.pdf",
      detail: "Official corporate financial and turnover reporting form.",
      url: "#"
    }
  ]);
          ...
          <div className="space-y-4">
            {documents.map((doc) => (
              <div key={doc.id} className="p-4 rounded-xl bg-gray-50 border border-gray-200 flex items-center justify-between hover:bg-emerald-50/50 transition">
                ...
                <a href={doc.url} className="p-2.5 bg-emerald-600 text-white rounded-xl hover:bg-emerald-500 shadow-md transition flex items-center gap-1 text-xs font-bold">
